...
export default function BasicDetailsScreen({ navigation }) {
    ...
    const handleNext = async () => {
        ...
        try {
            ...
            if (country) await AsyncStorage.setItem('user_country', country);
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                <View style={styles.header}>
                    <Text style={styles.stepIndicator}>STEP 01 // INITIALIZATION</Text>
                    <Text style={styles.title}>IDENTITY PARAMETERS</Text>
                ...
                <View style={styles.footer}>
                    <BlueprintButton title="INITIATE NEXT SEQUENCE" onPress={handleNext} />
                </View>
            </View>

            {/* Background Grid Lines for Blueprint Effect */}
